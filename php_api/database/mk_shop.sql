...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2025 at 08:58 PM
...
INSERT INTO `employees` (`employee_id`, `employee_name`, `username`, `password`, `salary`, `image`, `created_at`) VALUES
(1, 'KK', 'Krit', 'prokfds4223', '50500.00', '68f2944661141_1760728134.PNG', '2025-10-17 19:08:54'),
(2, 'tt', 'kk', '1234', '2000.00', NULL, '2025-10-24 17:01:10');
...
INSERT INTO `products` (`product_id`, `product_name`, `category_id`, `description`, `price`, `image`, `stock`, `created_at`) VALUES
...
(27, 'แดงโซดา', 3, '', '45.00', '1761330593_download.webp', 10, '2025-10-24 18:29:53'),
(28, 'ชาเขียว', 3, '', '45.00', '1761331277_กก.webp', 50, '2025-10-24 18:41:17');
